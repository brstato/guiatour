...
export function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0a0f1d] p-8 relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-orange-500/5 rounded-full blur-2xl pointer-events-none" />
      ...
      <div className="w-full max-w-md flex flex-col items-center z-10">
        ...
        <div className="w-full space-y-4">
          <Button
            ...
            className="w-full h-[48px] bg-orange-500 hover:bg-orange-600 text-slate-950 font-bold text-base rounded-xl transition-all flex items-center justify-center gap-3 shadow-lg shadow-orange-500/20 border-none"
          >
          ...
          <button
            ...
            className="w-full py-2 text-slate-500 hover:text-slate-400 transition-colors text-sm font-medium bg-transparent border-none cursor-pointer"
          >
            Suporte
          </button>
        </div>
        ...
        <div className="w-full hidden flex-col space-y-4 mt-8">
          ...
          <Button
            ...
            className="w-full bg-[#cc5500] hover:bg-[#a34400] text-white"
          >
            Entrar
          </Button>
        </div>
      ...
      <Dialog open={!!error} onOpenChange={(open) => !open && clearError()}>
        <DialogContent className="bg-gray-800 text-white border-gray-700">
          ...
          <DialogFooter>
            <Button onClick={clearError} className="bg-gray-700 hover:bg-gray-600">OK</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!message} onOpenChange={(open) => !open && clearMessage()}>
        <DialogContent className="bg-gray-800 text-white border-gray-700">
          ...
          <DialogFooter>
            <Button onClick={clearMessage} className="bg-gray-700 hover:bg-gray-600">OK</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
